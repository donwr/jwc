...
// Custom useFormState function to manage form state
...
const validators = {
  firstName: function Name(value) {
    return value.trim().length > 0 // Basic non-empty check
  },
  ...
  password: function Password(value) {
    return value.trim().length >= 6 // Example password validation
  },
}
