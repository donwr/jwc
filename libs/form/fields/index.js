...
//       value,
//       onChange,
//       idx, // Destructure idx prop here
//       ...props
//     },
//     ref, // Forward the ref here
//   ) => {
//     const { errors, isActive } = useFormContext()
...
//           s.field,
//           s.single,
//           isActive[idx] && s.active, // Use idx here
//           errors[idx]?.state && s.error, // Use idx here
//         )}
//       >
//         <input
//           type={type}
...
//         />
//         {errors[idx]?.state && (
//           <p className={s.errorMessage}>{errors[idx]?.message}</p>
//         )}
//       </div>
//     )
//   },
